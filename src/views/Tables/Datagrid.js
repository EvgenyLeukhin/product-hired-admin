...
class DataGrid extends Component {
    ...
    componentWillMount() {
        this.props.setHeaderTitle('DataGrid');
    }
    ...
    createRows = () => {
        ...
        for (let i = 1; i < 100; i++) {
            rows.push({
                id: i,
                task: "Task " + i,
                assigned: `img/user/0${Math.floor(Math.random() * 7) + 1}.jpg`,
                ...
                completeDate: this.getRandomDate(
                    new Date(),
                    new Date(2021, 0, 1)
                )
            });
        ...
        return (
            <section className="section-container">
                <div className="container-lg">
                    <p>Excel-like grid component built with React</p>
                    <ReactDataGrid
...
export default withHeaderTitle(DataGrid);
